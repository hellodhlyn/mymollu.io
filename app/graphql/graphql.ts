...
export type EventDetailQuery = { __typename?: 'Query', event: { __typename?: 'Event', name: string, type: EventTypeEnum, since: Date, until: Date, imageUrl: string | null, videos: Array<{ __typename?: 'Video', title: string, youtube: string, start: number | null }>, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, studentName: string, student: { __typename?: 'Student', studentId: string } | null }>, stages: Array<{ __typename?: 'Stage', difficulty: number, index: string, entryAp: number | null, rewards: Array<{ __typename?: 'StageReward', amount: number, item: { __typename?: 'Item', itemId: string, name: string, imageId: string, eventBonuses: Array<{ __typename?: 'ItemEventBonus', studentId: string, ratio: number }> } }> }> } | null };
