...
export type IndexQuery = { __typename?: 'Query', students: Array<{ __typename?: 'Student', studentId: string, name: string }>, contents: { __typename?: 'ContentInterfaceConnection', nodes: Array<{ __typename: 'Event', rerun: boolean, name: string, since: Date, until: Date, contentId: string, eventType: EventTypeEnum, pickups: Array<{ __typename?: 'Pickup', type: PickupTypeEnum, rerun: boolean, studentName: string, student: { __typename?: 'Student', studentId: string } | null }> } | { __typename: 'Raid', boss: string, terrain: TerrainEnum, attackType: Attack, defenseType: Defense, name: string, since: Date, until: Date, contentId: string, raidType: RaidTypeEnum }> } };
...
export type PickupEventsQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'Event', eventId: string, name: string, since: Date, until: Date, type: EventTypeEnum, rerun: boolean, pickups: Array<{ __typename?: 'Pickup', studentName: string, student: { __typename?: 'Student', studentId: string } | null }> }> }, students: Array<{ __typename?: 'Student', initialTier: number, studentId: string, name: string }> };
